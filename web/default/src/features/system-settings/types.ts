...
export type ModelPricingAuthority = "manual" | "official" | "fallback";

export type ModelPricingConfig = {
  mode?: "per-token" | "per-request" | "tiered_expr";
  price?: number;
  ratio?: number;
...
export type ModelPricingView = {
  model_name: string;
  authority: ModelPricingAuthority;
  authority_model_name: string;
  effective_config: ModelPricingConfig;
